...
def näita():
    ...
    järgmist_3_päeva = täna + datetime.timedelta(days=30)
    ...
    nimetused =  scrapimine(kuupäev1, kuupäev2, 'a.eventslist_item_title', '43166')
    kuupäev = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_date', '43166')
    piletihind = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_price_primary', '43166')
    ...
    gif1 = PhotoImage(file = 'LinksPildid/Rakvere/RakvereTeater.gif')
