...
def näita():
    ...
    järgmist_3_päeva = täna + datetime.timedelta(days=14)
    ...
    nimetused =  scrapimine(kuupäev1, kuupäev2, 'a.eventslist_item_title', '43181')
    kuupäev = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_date', '43181')
    piletihind = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_price_primary', '43181')
    ...
    gif1 = PhotoImage(file = 'LinksPildid/Kuressaare/KuressaareTeater.gif')
    ...
    lst.insert(END,"Kuressaare teater:")
    lst.insert(END, "        ")
