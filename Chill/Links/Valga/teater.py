...
def näita():
    ...
    nimetused =  scrapimine(kuupäev1, kuupäev2, 'a.eventslist_item_title', '44204')
    kuupäev = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_date', '44204')
    piletihind = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_price_primary', '44204')
    ...
    gif1 = PhotoImage(file = 'LinksPildid/Valga/ValgaTeater.gif')
