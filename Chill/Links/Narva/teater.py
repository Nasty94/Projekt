...
def näita():
    ...
    nimetused =  scrapimine(kuupäev1, kuupäev2, 'a.eventslist_item_title', '43189')
    kuupäev = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_date', '43189')
    piletihind = scrapimine(kuupäev1, kuupäev2, 'div.eventslist_item_price_primary', '43189')
    ...
    gif1 = PhotoImage(file = 'LinksPildid/Narva/NarvaTeater.gif')
